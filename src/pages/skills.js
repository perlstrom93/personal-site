...
const SkillsPage = () => (
  <Layout>
    <SEO title="Skills" />
    <h2>Skills</h2>
    <Section className="techList" borderRight>
      <h3>Web Dev</h3>
      <ul style={{ margin: 0 }}>
        <li
        ...
        <li
          className="techListItem"
          style={{ backgroundImage: `url(${WebpackImg})` }}
        >
          <ExternalLink to="https://webpack.js.org/">Webpack</ExternalLink>
        </li>
        <li
          className="techListItem"
          style={{ backgroundImage: `url(${HTML5Img})` }}
        >
          <ExternalLink to="https://en.wikipedia.org/wiki/HTML5">
            HTML5
          </ExternalLink>
        </li>
        <li
          className="techListItem"
          style={{ backgroundImage: `url(${CSS3Img})` }}
        >
          <ExternalLink to="https://en.wikipedia.org/wiki/Cascading_Style_Sheets">
            CSS3
          </ExternalLink>
        </li>
        <li
          className="techListItem"
          style={{ backgroundImage: `url(${AccessibilityImg})` }}
        >
          <ExternalLink to="https://www.w3.org/WAI/standards-guidelines/wcag/">
            Accessibility
          </ExternalLink>
        </li>
      </ul>
    ...
    <Section className="techList" borderRight>
      ...
      <ul style={{ margin: 0 }}>
        <li
          className="techListItem"
          style={{ backgroundImage: `url(${JestImg})` }}
        >
          <ExternalLink to="https://jestjs.io/">Jest</ExternalLink>
        </li>
        <li className="techListItem">
          <ExternalLink to="https://enzymejs.github.io/enzyme/">
            Enzyme
          </ExternalLink>
        </li>
        <li
          className="techListItem"
          style={{ backgroundImage: `url(${NightwatchImg})` }}
        >
          <ExternalLink to="https://nightwatchjs.org/">Nightwatch</ExternalLink>
        </li>
        <li className="techListItem">
          <ExternalLink to="https://en.wikipedia.org/wiki/Test-driven_development">
            Test Driven Development
          </ExternalLink>
        </li>
        <li className="techListItem">
          <ExternalLink to="https://en.wikipedia.org/wiki/Business-driven_development">
    ...
    <Section className="techList">
      ...
      <ul style={{ margin: 0 }}>
        <li
          className="techListItem"
          style={{ backgroundImage: `url(${JenkinsImg})` }}
        >
          <ExternalLink to="https://www.jenkins.io/">Jenkins</ExternalLink>
        </li>
        <li
          className="techListItem"
          style={{ backgroundImage: `url(${AppdImg})` }}
        >
          <ExternalLink to="https://www.appdynamics.com/">
            AppDynamics
          </ExternalLink>
        </li>
        <li
          className="techListItem"
          style={{ backgroundImage: `url(${SplunkImg})` }}
        >
          <ExternalLink to="https://www.splunk.com/">Splunk</ExternalLink>
        </li>
        <li
          className="techListItem"
          style={{ backgroundImage: `url(${GitImg})` }}
        >
